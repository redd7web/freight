...
switch($_GET['mode']){
    ...
    break;
    case "util":
    $grease_table = $dbprefix."_utility";
...
if(isset($_POST['facs']) && $_POST['facs'] !=" "){
...
$full = $db->query("SELECT * FROM $grease_table WHERE route_status IN ( 'scheduled','new')  AND  grease_route_no IS NULL && fire =1 AND facility_origin IN ($fac) ");
