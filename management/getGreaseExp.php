        ...
        switch($name){
            case "tank":
                if(strlen(trim($value))>0){
                    $arrFields[]= "ap_form_27963.element_55 = $value";
                }
            break;
            case "ikg":
                if(strlen(trim($value))>0){
...
<td><select name="format">case csv">CSV</option>case xls">XLS</option></select><input type="hidden"  name="param" value="<?php echo $format ?>" readonly=""/></td>
