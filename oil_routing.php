...
<div class="content-wrapper" style="min-height:450px;height: auto;">
    ...
    <div id="data_display" style="width:100%;margin:auto;height:auto;">
    <table style="width: 100%;padding:0px 0px 0px 0px;height:400px;">
    ...
    <tr><td colspan="15" style="border-collapse: collapse;height:auto;">
          <h3 id="expand" style="cursor: pointer;text-decoration:underline;"><img src="img/plus.png" style="height: 25px;width:25px;"/>Quick add stops</h3>
          <div id="expand_this" style="height: 400px;overflow:auto;padding:0px 0px 0px 0px;">
...
var remove_incompletes = 0;
    ...
    $("body").on("click",".deletesched",function(){//added stops by quick add
        $(this).closest('tr').remove();
         var account   = $("input#account_nos").val();
         var schedules = $("input#scheduled_ids").val();
         var replace_scheds = $(this).attr('rel')+"|";
         ...
         $('[rel='+$(this).attr('rel')+']').prop('checked',false);
    });
...
$("#expand").click(function(){
   $("#expand_this").toggle("slow") ;
});

$(".setThisRoute").click(function(){    
  
   if($(this).is(":checked")  ){
        $("input#scheduled_ids").val( $("input#scheduled_ids").val() + $(this).attr('rel')+"|"  );
        $("input#account_nos").val( $("input#account_nos").val() + $(this).attr('xlr')+"|" );
        $.get("added_row.php",{schedule_id: $(this).attr("rel")},function(data){
            alert(data);
            $("#add_stop_here").append(data);    
        });
        ...
        var newVal =  $("input#scheduled_ids").val().replace(replace,"");
        $("input#scheduled_ids").val(newVal);
        var replace1 = $(this).attr('xlr')+"|";
        var newVal2 =  $("input#account_nos").val().replace(replace1,"");
        $("input#account_nos").val(newVal2);
    }
