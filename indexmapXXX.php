...
<h2 style="width: 500px;margin:auto;">IWP - Route Optimization and Planning</h2>
...
<div id="bulkLoader_hidden" style="visibility: hidden;">
  ...
  <textarea name="inputList" rows="10" cols="70" placeholder="One destination per line">
  <?php
    foreach($grease_ikg->account_numbers as $acx){
        $ant = new Account($acx);
        echo $ant->address." "."$ant->city $ant->state, $ant->zip\r\n";
    }
  ?>
  </textarea><br>
