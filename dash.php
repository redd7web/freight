...
<tr>
    ...
    <td style="text-align: center;">
        ...
        <table><tr><td><h1><a href="viewAccount.php?id=201" target="_blank">Frac Tank 1</a></h1><iframe rel="201" id="guage201" src="plugins/jqwidgets-ver3.4.0/demos/jqxgauge/settings.php?account_no=201" style="width: 280px;float:left;height:550px;border:0px solid #bbb;overflow:hidden;" scrolling="no" frameborder="0"></iframe><br /></td></tr><tr><td><input class="row_count201" type="hidden" readonly="" value="<?php $check_complete = $db->query("SELECT DISTINCT(freight_list_of_grease.route_id),freight_list_of_grease.status FROM freight_list_of_grease LEFT JOIN freight_grease_data_table ON freight_grease_data_table.route_id = freight_list_of_grease.route_id WHERE freight_list_of_grease.status='completed' AND (freight_grease_data_table.account_no = 201 OR freight_grease_data_table.facility_origin =201 ) GROUP BY freight_list_of_grease.route_id");echo count($check_complete); ?>"/>
        <br />
    ...
    <td style="text-align: center;">
        ...
        <table><tr><td><h1><a href="viewAccount.php?id=202" target="_blank">Frac Tank 2</a></h1><iframe rel="202"  id="guage202" src="plugins/jqwidgets-ver3.4.0/demos/jqxgauge/settings.php?account_no=202" style="width: 280px;float:left;height:550px;border:0px solid #bbb;overflow:hidden;" scrolling="no" frameborder="0"></iframe></td></tr><tr><td><input class="row_count202"  type="hidden" readonly="" value="<?php $check_complete202 = $db->query("SELECT DISTINCT(freight_list_of_grease.route_id),freight_list_of_grease.status FROM freight_list_of_grease LEFT JOIN freight_grease_data_table ON freight_grease_data_table.route_id = freight_list_of_grease.route_id WHERE freight_list_of_grease.status='completed' AND (freight_grease_data_table.account_no = 202 OR freight_grease_data_table.facility_origin =202 ) GROUP BY freight_list_of_grease.route_id");echo count($check_complete202); ?>"/>
    ...
    <td style="text-align: center;">
        ...
        <table><tr><td><h1><a href="viewAccount.php?id=203" target="_blank">Frac Tank 3</a></h1><iframe rel="203"  id="guage203" src="plugins/jqwidgets-ver3.4.0/demos/jqxgauge/settings.php?account_no=203" style="width: 280px;float:left;height:550px;border:0px solid #bbb;overflow:hidden;" scrolling="no" frameborder="0"></iframe></td></tr><tr><td><input class="row_count203"  type="hidden" readonly="" value="<?php $check_complete3 = $db->query("SELECT DISTINCT(freight_list_of_grease.route_id),freight_list_of_grease.status FROM freight_list_of_grease LEFT JOIN freight_grease_data_table ON freight_grease_data_table.route_id = freight_list_of_grease.route_id WHERE freight_list_of_grease.status='completed' AND (freight_grease_data_table.account_no = 203 OR freight_grease_data_table.facility_origin =203 ) GROUP BY freight_list_of_grease.route_id");echo count($check_complete3); ?>"/>
...
<tr>
    ...
    <table><tr><td><h1><a href="viewAccount.php?id=204" target="_blank">Frac Tank 4</a></h1><iframe rel="204"  id="guage204" src="plugins/jqwidgets-ver3.4.0/demos/jqxgauge/settings.php?account_no=204" style="width: 280px;float:left;height:550px;border:0px solid #bbb;overflow:hidden;" scrolling="no" frameborder="0"></iframe></td></tr><tr><td><input class="row_count204"  type="hidden" readonly="" value="<?php $check_complete4 = $db->query("SELECT DISTINCT(freight_list_of_grease.route_id),freight_list_of_grease.status FROM freight_list_of_grease LEFT JOIN freight_grease_data_table ON freight_grease_data_table.route_id = freight_list_of_grease.route_id WHERE freight_list_of_grease.status='completed' AND (freight_grease_data_table.account_no = 204 OR freight_grease_data_table.facility_origin =204 ) GROUP BY freight_list_of_grease.route_id");echo count($check_complete4); ?>"/>
    <span id="ft204"></span></td></tr></table>
    </td>
    
    
    <td style="text-align: center;">
        <table><tr><td><h1><a href="viewAccount.php?id=205" target="_blank">Frac Tank 5</a></h1><iframe rel="205"  id="guage205" src="plugins/jqwidgets-ver3.4.0/demos/jqxgauge/settings.php?account_no=205" style="width: 280px;float:left;height:550px;border:0px solid #bbb;overflow:hidden;" scrolling="no" frameborder="0"></iframe></td></tr><tr><td><input class="row_count205"  type="hidden" readonly="" value="<?php $check_complete5 = $db->query("SELECT DISTINCT(freight_list_of_grease.route_id),freight_list_of_grease.status FROM freight_list_of_grease LEFT JOIN freight_grease_data_table ON freight_grease_data_table.route_id = freight_list_of_grease.route_id WHERE freight_list_of_grease.status='completed' AND (freight_grease_data_table.account_no = 205 OR freight_grease_data_table.facility_origin =205 ) GROUP BY freight_list_of_grease.route_id");echo count($check_complete5); ?>"/>
    <span id="ft205"></span></td></tr></table>
    
    </td>
    <td style="text-align: center;">
    <table><tr><td><h1><a href="viewAccount.php?id=206" target="_blank">Frac Tank 6</a></h1><iframe rel="206"  id="guage206" src="plugins/jqwidgets-ver3.4.0/demos/jqxgauge/settings.php?account_no=206" style="width: 280px;float:left;height:550px;border:0px solid #bbb;overflow:hidden;" scrolling="no" frameborder="0"></iframe></td></tr><tr><td><input class="row_count206"  type="hidden" readonly="" value="<?php $check_complete6 = $db->query("SELECT DISTINCT(freight_list_of_grease.route_id),freight_list_of_grease.status FROM freight_list_of_grease LEFT JOIN freight_grease_data_table ON freight_grease_data_table.route_id = freight_list_of_grease.route_id WHERE freight_list_of_grease.status='completed' AND (freight_grease_data_table.account_no = 206 OR freight_grease_data_table.facility_origin =206 ) GROUP BY freight_list_of_grease.route_id");echo count($check_complete6); ?>"/>
...
<tr>
    ...
    <table><tr><td><h1><a href="viewAccount.php?id=207" target="_blank">Frac Tank 7</a></h1><iframe rel="207"  id="guage207" src="plugins/jqwidgets-ver3.4.0/demos/jqxgauge/settings.php?account_no=207" style="width: 280px;float:left;height:550px;border:0px solid #bbb;overflow:hidden;" scrolling="no" frameborder="0"></iframe></td></tr><tr><td><input class="row_count207"  type="hidden" readonly="" value="<?php $check_complete7 = $db->query("SELECT DISTINCT(freight_list_of_grease.route_id),freight_list_of_grease.status FROM freight_list_of_grease LEFT JOIN freight_grease_data_table ON freight_grease_data_table.route_id = freight_list_of_grease.route_id WHERE freight_list_of_grease.status='completed' AND (freight_grease_data_table.account_no = 207 OR freight_grease_data_table.facility_origin =207 ) GROUP BY freight_list_of_grease.route_id");echo count($check_complete7); ?>"/>
    <span id="ft207"></span></td></tr></table>
    </td>
    
    <td style="text-align: center;">
    
    <table><tr><td><h1><a href="viewAccount.php?id=208" target="_blank">Frac Tank 8</a></h1><iframe rel="208"  id="guage208" src="plugins/jqwidgets-ver3.4.0/demos/jqxgauge/settings.php?account_no=208" style="width: 280px;float:left;height:550px;border:0px solid #bbb;overflow:hidden;" scrolling="no" frameborder="0"></iframe></td></tr><tr><td><input class="row_count208"  type="hidden" readonly="" value="<?php $check_complete8 = $db->query("SELECT DISTINCT(freight_list_of_grease.route_id),freight_list_of_grease.status FROM freight_list_of_grease LEFT JOIN freight_grease_data_table ON freight_grease_data_table.route_id = freight_list_of_grease.route_id WHERE freight_list_of_grease.status='completed' AND (freight_grease_data_table.account_no = 208 OR freight_grease_data_table.facility_origin =208 ) GROUP BY freight_list_of_grease.route_id");echo count($check_complete8); ?>"/>
    <span id="ft208"></span></td></tr></table>
    
    </td>
    <td style="text-align: center;">
    
    <table><tr><td><h1><a href="viewAccount.php?id=209" target="_blank">Frac Tank 9</a></h1><iframe rel="209"  id="guage209" src="plugins/jqwidgets-ver3.4.0/demos/jqxgauge/settings.php?account_no=209" style="width: 280px;float:left;height:550px;border:0px solid #bbb;overflow:hidden;" scrolling="no" frameborder="0"></iframe></td></tr><tr><td><input class="row_count209"  type="hidden" readonly="" value="<?php $check_complete9 = $db->query("SELECT DISTINCT(freight_list_of_grease.route_id),freight_list_of_grease.status FROM freight_list_of_grease LEFT JOIN freight_grease_data_table ON freight_grease_data_table.route_id = freight_list_of_grease.route_id WHERE freight_list_of_grease.status='completed' AND (freight_grease_data_table.account_no = 209 OR freight_grease_data_table.facility_origin =209 ) GROUP BY freight_list_of_grease.route_id");echo count($check_complete9); ?>"/>
...
<tr>
    <td style="text-align: center;">
        <table><tr><td><h1><a href="viewAccount.php?id=210" target="_blank">Frac Tank 210</a></h1><iframe rel="210"  id="guage210" src="plugins/jqwidgets-ver3.4.0/demos/jqxgauge/settings.php?account_no=210" style="width: 280px;float:left;height:550px;border:0px solid #bbb;overflow:hidden;" scrolling="no" frameborder="0"></iframe></td></tr><tr><td><input class="row_count210"  type="hidden" readonly="" value="<?php $check_complete10 = $db->query("SELECT DISTINCT(freight_list_of_grease.route_id),freight_list_of_grease.status FROM freight_list_of_grease LEFT JOIN freight_grease_data_table ON freight_grease_data_table.route_id = freight_list_of_grease.route_id WHERE freight_list_of_grease.status='completed' AND (freight_grease_data_table.account_no = 210 OR freight_grease_data_table.facility_origin =210 ) GROUP BY freight_list_of_grease.route_id");echo count($check_complete10); ?>"/><span id="ft210"></span></td></tr></table>
    </td>
    <td style="text-align: center;">
        <table><tr><td><h1><a href="viewAccount.php?id=211" target="_blank">Frac Tank 211</a></h1><iframe rel="211"  id="guage211" src="plugins/jqwidgets-ver3.4.0/demos/jqxgauge/settings.php?account_no=211" style="width: 280px;float:left;height:550px;border:0px solid #bbb;overflow:hidden;" scrolling="no" frameborder="0"></iframe></td></tr><tr><td><input class="row_count211"  type="hidden" readonly="" value="<?php $check_complete11 = $db->query("SELECT DISTINCT(freight_list_of_grease.route_id),freight_list_of_grease.status FROM freight_list_of_grease LEFT JOIN freight_grease_data_table ON freight_grease_data_table.route_id = freight_list_of_grease.route_id WHERE freight_list_of_grease.status='completed' AND (freight_grease_data_table.account_no = 211 OR freight_grease_data_table.facility_origin =211 ) GROUP BY freight_list_of_grease.route_id");echo count($check_complete11); ?>"/><span id="ft211"></span></td></tr></table>
    </td>
</tr>
